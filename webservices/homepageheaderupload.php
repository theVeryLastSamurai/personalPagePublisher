<?php
	...
	$target_path = "../app_data/img/homepageheader/".$_SESSION['LoggedIn'].".";
    ...
    $query="UPDATE `ppp_db`.`website` SET `homepage_header_address` = '".basename($target_file)."' WHERE `website`.`websiteno` = ".$websiteno." ;";

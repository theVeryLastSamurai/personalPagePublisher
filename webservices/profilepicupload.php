<?php
	...
	$target_path = "../app_data/img/profilepic/".$_SESSION['LoggedIn'].".";
    ...
    $query="UPDATE `ppp_db`.`user` SET `pic_address` = '".basename($target_file)."' WHERE `user`.`username` = '".$_SESSION['LoggedIn']."';";

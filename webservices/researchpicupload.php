<?php
	...
	$target_path = "../app_data/img/researchpic/".$_SESSION['LoggedIn']."_".$_REQUEST['topicno'].".";
    ...
    $query="UPDATE `ppp_db`.`research_topic` SET `pic_address` = '".basename($target_file)."' WHERE `topicno` = '".$_REQUEST['topicno']."' ;";

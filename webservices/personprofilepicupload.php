<?php
	...
	$target_path = "../app_data/img/peoplepic/".$_SESSION['LoggedIn']."_".$_REQUEST['personno'].".";
    ...
    $query="UPDATE `ppp_db`.`person` SET `pic_address` = '".basename($target_file)."' WHERE `person`.`personno` = '".$_REQUEST['personno']."' ;";

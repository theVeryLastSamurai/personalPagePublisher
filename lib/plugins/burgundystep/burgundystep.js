    ...
    BurgundyStep.prototype = {
        ...
        init: function() {
            ...
            $("head").append("\
                <style>\
                    ...
                    div.step >ul >li.Special{\
                        background-color: #26A65B !important;\
                    }\
                    div.step >ul >li.Special:hover{\
                        background-color: #26A65B !important;\
                    }\
                </style>\
            ;")
        ...
        defaultadd: function(el, options) {
            ...
            if(this.options.specialbutton){
                var func=this.options.specialbuttoncallback;
                var unfunc=this.options.unspecialbuttoncallback;
                $(this.element).find("ul[role=tablist] li:last .HeadingStep").click(function(){
                    if($(this).closest("li[role=step]").hasClass("active")){
                        var bool=!$(this).closest("li[role=step]").hasClass("Special");
                        $(el).find("li[role=step]").removeClass("Special");
                        $(el).find(".HeadingStep").removeClass("fa-times-circle").addClass("fa-check-circle");
                        if(bool){
                            $(this).closest("li[role=step]").addClass("Special");
                            $(this).removeClass("fa-check-circle").addClass("fa-times-circle");
                            if(typeof func=="function")
                                func($(this).closest("li[role=step]"));
                        }else if(typeof unfunc=="function"){
                            unfunc($(this).closest("li[role=step]"));
                        }
                    }
                });
            }

<?php
	...
	$query=array(
		"INSERT INTO `user` (`username`, `password`, `email`, `pic_address`, `websiteno`, `profilepic_caption`, `ldap`) VALUES ('".$_REQUEST['username']."', '".$_REQUEST['password']."', '".$_REQUEST['email']."', '', '".$websiteno."', 'FirstName LastName<br/>Assistant Prof. @IASBS ,Zanjan<br/>Email: myemail@iasbs.ac.r<br/>Tel: 024-3355-1111<br/>Office #: 19',0);",
